...
export default function Home() {
  useEffect(() => {
    // This creates the floating orb effect in the background
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center p-8 bg-gray-900 overflow-hidden">
      ...
      <div className="orb fixed w-80 h-80 rounded-full bg-blue-500 opacity-10 blur-3xl -left-40 -top-40" data-speed="5"></div>
      <div className="orb fixed w-96 h-96 rounded-full bg-purple-500 opacity-10 blur-3xl -right-60 bottom-20" data-speed="8"></div>
      <div className="orb fixed w-64 h-64 rounded-full bg-cyan-500 opacity-10 blur-3xl left-1/4 bottom-1/3" data-speed="3"></div>
      ...
      <div className="relative bg-gray-800 rounded-2xl p-10 text-center w-full max-w-md border border-gray-700 backdrop-blur-sm bg-opacity-50 shadow-2xl overflow-hidden">
        {/* Animated border */}
        <div className="absolute inset-0 border-2 border-transparent rounded-2xl animate-border-pulse pointer-events-none" style={{
      ...
      <style jsx global>{`
        @keyframes borderPulse {
          0% { box-shadow: 0 0 5px rgba(59, 130, 246, 0.3); border-color: rgba(59, 130, 246, 0.1); }
          50% { box-shadow: 0 0 20px rgba(59, 130, 246, 0.6); border-color: rgba(59, 130, 246, 0.4); }
          100% { box-shadow: 0 0 5px rgba(59, 130, 246, 0.3); border-color: rgba(59, 130, 246, 0.1); }
        }
        @keyframes ping-slow {
